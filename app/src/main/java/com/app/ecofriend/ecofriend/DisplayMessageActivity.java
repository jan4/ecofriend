...
public class DisplayMessageActivity extends AppCompatActivity {
    ...
    private void createTaskText() {
        ...
        textView.setText("Recycling 20 bottles");
        ...
        switch (requestCode) {
            case REQUEST_WRITE_PERMISSION:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(DisplayMessageActivity.this, "Permission Denied!", Toast.LENGTH_SHORT).show();
                }
        }
    }
            ...
            try {
                ...
                if (detector.isOperational() && bitmap != null) {
                    ...
                    for (int index = 0; index < barcodes.size(); index++) {
                        ...
                        scanResults.setText(scanResults.getText() + "20 bottles recycled by " + code.displayValue + "\n");
                        TextView textView = (TextView) findViewById(R.id.textView3);
                        textView.setText("");
